...
TRANSITIONS_MODULE = 'did_the_rocket_launch_yet.transitions'
...
# error messages.
DEFAULT_STATE = 'did_the_rocket_launch_yet.states.StartState'
...
USERS_READING_SPEED = 1000

# URL API

API_URL = getenv('API_URL', 'https://framex-dev.wadrid.net/api/video/')
